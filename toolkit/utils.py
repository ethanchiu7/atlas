...
class MapReduceBase(object):
    ...
    def __init__(self, role_type='mapper', seq='\t', key_index=0, columns_num=2, is_json=False, **kwargs):
        """
        e.g.
            index_name_dict = {
            1: 'name1',
        ...
        if 'index_name_dict' in kwargs and isinstance(kwargs['index_name_dict'], dict):
            self.__index_name_dict = kwargs['index_name_dict']
        else:
